...
$noticiasQtd = $db->json(
	'
	select count(id_noticia) as qtd from noticia
	'
	,
	null
);

$total = intval($noticiasQtd[0]['qtd']);

$i = intVal($id) ? intval($id) : 0;

$prox = $i + LIMIT < $total ? intval($i + LIMIT) : null;

$ant = $i - LIMIT >= 0 ? intval($i - LIMIT) : null;
			...
			<div class="container">
				...
				<div class="section-title" data-aos="fade-up">
					<h2>
						...
						Notícias
						<a class="back-arrow share" href="#" text="Notícias" title="Compartilhar">
					...
					<nav aria-label="..." class='d-flex  justify-content-center'>
						<ul class="pagination">
							<li class="page-item <?php echo $i > 0 ? '' : ' disabled '; ?>">
								<a class="page-link" href="../../noticias/<?php echo $ant; ?>/b">Página Anterior</a>
							</li>
							...
							<li class="page-item <?php echo $prox == null ? ' disabled ' : ''; ?>">
								<a class="page-link" href="../../noticias/<?php echo $prox; ?>/b">Próxima Página</a>
							</li>
						</ul>
					</nav>
				...
				<div class="row">
					...
					<?php foreach ($noticias as $k => $v) { ?>
						...
						<div class="col-lg-4 col-md-6 d-flex align-items-stretch justify-content-center noticia">

							<div class="member" data-aos="zoom-in">
								<a href="../../noticia/<?php echo $v['id_noticia']; ?>/automacao-telemetria">
									<div class="member-info fim">
										<!-- <div class='text-center' data-aos="zoom-in">
											<a href="../../noticia/<?php echo $v['id_noticia']; ?>/automacao-telemetria">
												<i class="bi bi-newspaper"></i> Ver Notícia
											</a>
										</div> -->

										<h4 class>
											<?php echo $v['ds_noticia']; ?>
								...
								<div class='text-center ver-noticia' data-aos="zoom-in">
									<a href="../../noticia/<?php echo $v['id_noticia']; ?>/automacao-telemetria">
										<i class="bi bi-newspaper"></i> Ver Notícia
									</a>
								</div>
				...
				<div class='shareDiv share' text='Notícias'>
