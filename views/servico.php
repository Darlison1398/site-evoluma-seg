...
$servicos = $db->json(
	...
	left JOIN foto f on f.id_servico = s.id_servico
...
$fotos = $db->json(
	...
	where id_servico = :id and home <> 1 and capa <> 1
...
$META_TITLE = strtoupper($servicos[0]["ds_servico"]);


if (sizeof($servicos))
	$META_KEYWORDS = strlen($servicos[0]['palavras_chaves_servico']) ? $servicos[0]['palavras_chaves_servico'] : $META_KEYWORDS;
			...
			<div class="container">
				...
				<div class="section-title" data-aos="fade-left">
					<h2>
						...
						<?php echo $servicos[0]["ds_servico"]; ?>
						
						<a class="back-arrow share" href="#" text="<?php echo $servicos[0]["ds_servico"]; ?>" title="Compartilhar">
					...
					foreach ($servicos as $k => $v) {
						...
						<div class="col  d-flex justify-content-center " data-aos="zoom-in">
							...
							<div class="noticia-texto">
								<?php echo strJsonToHtml($v['texto_servico']); ?>
							</div>
							<!-- </a> -->
						</div>
				...
				<div class='shareDiv share' text='<?php echo $servicos[0]["ds_servico"]; ?>'>
