...
// 	order by id_produto, ordem_foto asc
// 	limit 20
// 	'
// 	,
// 	null
			...
			<div class="container">
				...
				<div class="section-title" data-aos="fade-right">
					<h2>
						...
						<a class="back-arrow share" href="#" text="Conheça nossos produtos" title="Compartilhar">
				...
				<div class="row botoes">
					...
					foreach ($produtos as $k => $v) {
						...
						<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6  d-flex justify-content-center botaoProduto"
							data-aos="zoom-in">
							<a href="../produto/<?php echo $v['id_produto']; ?>/<?php echo nameToUrl($v['ds_produto']); ?>">
								<div>
									...
									if ($v['produto_img']) {
										...
										<img src="../<?php echo PATH_IMGS . $v['produto_img']; ?>"
											alt="<?php echo $v['produto_img']; ?>" class="w100" />
								...
								<h3>
									<?php echo $v['ds_produto']; ?>
								</h3>
								<div class='det'>
									<?php echo ($v['resumo_produto']); ?>
								</div>
							</a>
						</div>
				...
				<div class='shareDiv share' text='Conheça nossos produtos'>
