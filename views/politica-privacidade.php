...
$produtos = $db->json(
	'
	select s.*, f.img_foto as produto_img from produto s
	left JOIN foto f on f.id_produto = s.id_produto and f.capa = "1"
	GROUP BY s.id_produto
	order by s.ordem_produto asc, s.id_produto asc
	'
	,
	null
);
	...
	<main id="main">
		...
		<section class='sobre'>
			<div class='container'>
				...
				<p>A sua privacidade é importante para nós. Esta política resume como coletamos, usamos e protegemos
					seus dados:</p>

				<ol>
					<li><strong>Coleta de Dados:</strong> Coletamos informações pessoais apenas quando necessário e com
						seu consentimento.</li>
					<li><strong>Uso de Dados:</strong> Utilizamos seus dados para melhorar nossos serviços e
						personalizar sua experiência.</li>
					<li><strong>Segurança:</strong> Protegemos suas informações e não compartilhamos com terceiros sem
						sua autorização.</li>
					<li><strong>Cookies:</strong> Usamos cookies para melhorar o desempenho do site; você pode gerenciar
						suas preferências.</li>
					<li><strong>Acesso e Controle:</strong> Você tem direito de acessar, corrigir ou excluir seus dados
						a qualquer momento.</li>
					<li><strong>Atualizações:</strong> Esta política pode ser atualizada; verifique periodicamente para
						ficar atualizado.</li>
				</ol>

				<p>Obrigado por confiar em nós com suas informações!</p>
