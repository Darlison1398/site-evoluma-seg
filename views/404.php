...
<body>
	...
	<div id='app'>
		<main id="main" data-aos="fade-up" class="text-center">

			<div class="p-5 bg-light rounded-3">
				<div class="container-fluid py-5">
					<h1 class="display-1 fw-bold">ERRO 404</h1>
					<p class="fs-4">Opa, não conseguimos encontrar esta página.</p>
					<a href="./home/">
						<button class="btn btn-primary btn-lg" type="button">Página Inicial</button>
					</a>
				</div>
			</div>
