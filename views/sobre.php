...
$sobre = $db->json(
	'
	select s.* from sobre s
	where s.ativo_sobre = 1
...
//	die();
	$sobre = array(
		array("ds_sobre" => "Não informado", "texto_sobre" => "Não informado")
	);
}
			...
			<div class="container">
				...
				<div class="section-title" data-aos="fade-left">
					<h2>
						...
						<?php echo $sobre[0]["ds_sobre"]; ?>
						<a class="back-arrow share" href="#" text="<?php echo $sobre[0]["ds_sobre"]; ?>"
							title="Compartilhar">
				...
				<div class='shareDiv share' text='<?php echo $sobre[0]["ds_sobre"]; ?>'>
